                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            ...
                            <form action="{{ route('admin.logout_handler') }}" method="post" 
                                id="adminLogoutForm">@csrf
                            </form>
                            <script>
                                function logoutAdmin(event) {

                                    event.preventDefault(); document.getElementById('adminLogoutForm').submit()
                                }
                            </script>
                        </div>
                    </div>
    ...
    <div class="right-sidebar">
        ...
        <div class="right-sidebar-body customscroll">
            <div class="right-sidebar-body-content">
                ...
                <div class="sidebar-radio-group mb-10 pb-10">
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 border-radius-4 box-shadow mb-30 bg-white">
                    @yield('content')
                </div>
            </div>
        </div>
